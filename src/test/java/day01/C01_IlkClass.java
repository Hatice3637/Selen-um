...
public class C01_IlkClass {
    ...
    public static void main(String[] args) {
      ...
      System.setProperty("webdriver.chrome.driver","src/resources/drivers/chromedriver.exe") ;
        ...
        System.out.println("actuel title" + driver.getTitle());//gidilen stenin başlığını yazdırı.
        System.out.println("actuel url " + driver.getCurrentUrl());//url yi getirir

        System.out.println("driver.getPageSource() = " + driver.getPageSource());//kaynak kodlar
    }
}
